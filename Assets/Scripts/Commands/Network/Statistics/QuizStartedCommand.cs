...
{
    public class QuizStartedCommand : BaseNetworkCommand
    {
        private string apiPath = APIPaths.QUIZ_STARTED.ToDescription();
        private QuizStartedRequestModel request;
        ...
        public override void Execute()
        {
            ...
            {
                request = EventData.data as QuizStartedRequestModel;
            }
            else
            {
                Debug.LogError("No data");
                request = new QuizStartedRequestModel();
            }
