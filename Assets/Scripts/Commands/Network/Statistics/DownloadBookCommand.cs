...
{
    public class DownloadBookCommand : BaseNetworkCommand
    {
        private string apiPath = APIPaths.BOOK_DOWNLOADED.ToDescription();
        private DownloadedOpenedBookRequestModel request;
        ...
        public override void Execute()
        {
            ...
            {
                request = EventData.data as DownloadedOpenedBookRequestModel;
            }
            else
            {
                Debug.LogError("No data");
                request = new DownloadedOpenedBookRequestModel();
            }
