...
namespace Vuplex.WebView.Demos {
    ...
    class HardwareKeyboardListener : MonoBehaviour {
        ...
        public static HardwareKeyboardListener Instantiate(Transform parent)
        {
            GameObject keyboard = new GameObject("HardwareKeyboardListener");
            keyboard.transform.SetParent(parent);
            return (HardwareKeyboardListener)keyboard.AddComponent<HardwareKeyboardListener>();
        }
