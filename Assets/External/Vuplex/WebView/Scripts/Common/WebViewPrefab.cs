    ...
    public class WebViewPrefab : MonoBehaviour {
        ...
        void _init(float width, float height, WebViewOptions options = new WebViewOptions(), IWebView initializedWebView = null) {
            ...
            if (InitialResolution <= 0) {
                ...
                if (webView.IsInitialized) {
                    WebViewLogger.LogWarning("Custom InitialResolution setting will be ignored because an initialized IWebView was provided.");
                } else {
        ...
        void OnDestroy() {
            ...
            return; // problem with material on UWP
#endif
