        ...
        void _enableProprietaryVideoCodecs() {
            ...
            try {
                ...
                if (Application.platform == RuntimePlatform.OSXEditor) {
                    ...
                    Debug.LogWarning("An error occurred while enabling proprietary video codecs for macOS. This can happen if the file path is over 255 characters in length. Error: " + e.ToString());
                }
            }
            _codecsEnabled = true;
        }
